...
'Approved': 'Aprovado',
'Approver': 'Aprovador',
'Archived Cases':'Casos arquivados',
...
'Beneficiary Types':'Tipos de beneficiários',
...
'Border Crossings':'Passagens de Fronteira',
...
'City': 'Cidade',
'City / Town / Village':'Cidade / Município / Vila',
'Civil Unrest': 'Agitação Civil',
...
'Country': 'País',
'County / District':'Município / Distrito',
...
'Date Needed By':'Data necessária até',
...
'Department Catalog':'Catálogo de departamentos',
...
'Epidemic': 'Epidemia',
'Explosion': 'Explosão',
'Extreme Winter Conditions': 'Condições Extremas de Inverno',
'Edit': 'Editar',
'edit': 'editar',
...
'Expiration Report':'Relatório de Expiração',
'Expiry Date': 'Data de expiração',
'Expiring Staff Contracts Report':'Relatório de contratos com funcionários vencidos',
...
'First Name': 'Primeiro Nome',
'Fishing': 'Pesca',
'Food Security': 'Vigilância Sanitária',
'Flash Flood': 'Enxurrada',
...
'Housing Types':'Tipos de Habitação',
...
'hourly': 'por hora',
'Hours': 'Horas',
'Hours by Role Report':'Relatório de Horas por Função',
'Hours by Program Report':'Relatório Horas por Programa',
...
'Indirect support cost HQ':'Custo de suporte administrativo',
...
'Job Title Catalog':'Catálogo do Cargo',
'Jobs': 'Tarefas',
'Journal': 'Diário',
...
'Land Slide': 'Desmoronamento',
'Language': 'Linguagem',
'Local Storm': 'Tempestade Local',
...
'Layout': 'Modelo',
'Lead Implementer':'Implementador Líder',
'Leader': 'guia',
...
'List All Requests': 'Listar todos os Pedidos',
'List All Vehicles':'Listar todos os veículos',
...
'List Recurring Requests':'Listar solicitações recorrentes',
...
'Membership updated': 'Associação atualizada',
'Membership Types':'Tipos de associação',
...
'Monetization Report':'Relatório de monetização',
...
'Open, Unspecified':'Aberto, não especificado',
...
'Poor': 'Pobre',
'Population Movement': 'Movimento Populacional',
...
'postponed': 'adiado',
'Posts':'Postagens',
'Posts can be either full pages, embedded within other pages or part of a series (for use as news items or blog posts)':'As postagens podem ser páginas inteiras, incorporadas em outras páginas ou parte de uma série (para uso como itens de notícias ou postagens de blog)',
'Poultry': 'Aves',
...
'Procurement & Logistics cost':'Custo de aquisição e logística',
'Program': 'Programa',
'Programs':'Programas',
...
'Rockfall': 'Deslizamento de rocha',
'Race': 'Corrida',
...
'Received/Incoming Shipments':'Remessas recebidas / encomendadas ',
...
'Requested For Facility':'Solicitado para instalação',
...
'Search All Requested Skills':'Pesquisar todas as habilidades solicitadas',
...
'Search location in Geonames':'Pesquisar localização nos nomes geográficos',
...
'Search Shipped Items':'Pesquisar itens enviados',
...
'Search Training Participants':'Pesquisar participantes do treinamento',
...
'Show %(number)s entries': 'Exibir %(number)s resultados',
...
'Showing _START_ to _END_ of _TOTAL_ entries': 'Exibindo de _START_ a _END_ de _TOTAL_ resultados',
'sides': 'lados',
...
'Staff Report':'Relatório da equipe',
...
'Summary': 'Sumário',
'Summary of Incoming Supplies':'Resumo de suprimentos recebidos',
'Summary of Releases':'Resumo das Liberações',
...
'This module allows the editing of page content using a web browser':'Este módulo permite a edição do conteúdo da página usando um navegador da web',
...
'Training Report':'Relatório de treinamento',
...
'Utilization Report':'Relatório de Utilização',
...
'Vehicle': 'Veículo',
'Vehicles are assets with some extra details.':'Veículos são ativos com alguns detalhes extras.',
...
'View as Pages':'Ver como páginas',
...
'Volunteer Role':'Função de voluntário',
'Volunteer Role Catalog':'Catálogo de Funções de Voluntário',
'Volunteer updated': 'Voluntário atualizado',
'Volunteers': 'Voluntários',
'volunteers': 'voluntários',
'Volunteers List': 'Voluntários Lista',
'Volunteer Report':'Relatório de Voluntariado',
...
'Warehouse Stock':'Estoque de armazém',
